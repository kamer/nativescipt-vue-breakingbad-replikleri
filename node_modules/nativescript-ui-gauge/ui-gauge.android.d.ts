...
export declare class RadRadialGauge extends commonModule.RadRadialGauge {
    private _android;
    readonly nativeObject: com.telerik.widget.gauge.RadRadialGaugeView;
    readonly _nativeView: com.telerik.widget.gauge.RadRadialGaugeView;
...
export declare class RadialScale extends commonModule.RadialScale {
    ...
    readonly nativeObject: com.telerik.widget.scales.GaugeRadialScale;
    readonly _nativeView: com.telerik.widget.scales.GaugeRadialScale;
...
export declare class RadialNeedle extends commonModule.RadialNeedle {
    ...
    readonly nativeObject: com.telerik.widget.indicators.GaugeRadialNeedle;
    readonly _nativeView: com.telerik.widget.indicators.GaugeRadialNeedle;
...
export declare class RadialBarIndicator extends commonModule.RadialBarIndicator {
    ...
    readonly nativeObject: com.telerik.widget.indicators.GaugeRadialBarIndicator;
    readonly _nativeView: com.telerik.widget.indicators.GaugeRadialBarIndicator;
}
